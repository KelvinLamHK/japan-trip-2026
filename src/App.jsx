...
function App() {
  return (
    <div className="min-h-screen bg-gray-900">
      ...
      {/* Hero Section - 全屏宽度，不对称布局 */}
      <section className="pt-20 pb-16 px-0 sm:px-4 lg:px-8">
        <div className="w-full max-w-7xl mx-auto">
          <div className="text-center">
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-8xl font-black text-white mb-8 leading-tight">
              日本冬季之旅
      ...
      {/* Route Map - 不对称布局 */}
      <section className="py-12 px-0 sm:px-4 lg:px-8">
        <div className="w-full max-w-7xl mx-auto">
          <div className="bg-white rounded-2xl shadow-2xl p-6 sm:p-8 lg:p-12">
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-8">
              <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4 lg:mb-0">行程路線圖</h2>
            ...
            <div className="relative">
              <img
                ...
                alt="日本冬季之旅路線圖"
                className="w-full h-64 sm:h-80 lg:h-[28rem] object-cover object-[center_20%] rounded-xl shadow-lg"
                onError={(e) => {
                  e.target.style.display = 'none';
                  e.target.nextSibling.style.display = 'block';
                }}
              />
              <div className="hidden bg-gray-100 rounded-xl h-64 sm:h-80 lg:h-[28rem] flex items-center justify-center">
                <div className="text-center">
                  <svg className="w-20 h-20 mx-auto mb-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7" />
                  </svg>
                  <p className="text-gray-500 text-lg">路線圖將在此顯示</p>
                </div>
              </div>
            </div>
          </div>
